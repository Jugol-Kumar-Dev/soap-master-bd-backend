        ...
        <footer class="footer footer-static footer-light">
            <p class="clearfix mb-0"><span class="float-md-start d-block d-md-inline-block mt-25">COPYRIGHT &copy;
                    2021<a class="ms-25" href="#"
                        ...
                        Reserved</span></span><span class="float-md-end d-none d-md-block text-sm" style="font-size:10px">Hand-crafted & Made with | <a href="https://www.fb.com/zogul.kumar/">Jugol Kumar</a> creativetechpark</span></p>
        </footer>
