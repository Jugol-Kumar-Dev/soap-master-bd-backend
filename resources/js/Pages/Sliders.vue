    ...
    <Layout>
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Slider List</h2>
                    </div>
                </div>
            </div>
            <div class="content-header-right text-md-end col-md-3 col-12 d-md-block d-none">
                <div class="mb-1 breadcrumb-right">
                    <button class="dt-button add-new btn btn-primary" tabindex="0" type="button" data-bs-toggle="modal"
                            data-bs-target="#createNewCategory"><span>Add Slider</span></button>
                </div>
            </div>
        </div>
        <section class="app-user-list">
            ...
            <div class="row row-cols-md-3">
                <div  v-for="promo in sliders.data" :key="promoid"  class="col">
                    <div class="card rounded-md">
                        <div class="card-body">
                            <div class="course-card">
                                <div class="course-card__thumbnail">
                                    <img :src="promo.photo" @error="errorImage" class="w-100 object-fit-cover" style="max-height: 200px;">
                                </div>
            ...
            <Pagination :links="sliders.links" :from="sliders.from" :to="sliders.to"
                        :total="sliders.total"/>
        </section>

        <!-- Modal to add new user starts-->
        <Modal id="createNewCategory" title="Create New Slider" v-vb-is:modal>
            <form @submit.prevent="createNewCategory">
                <div class="modal-body">
                    <Text v-model="createForm.title" :error="props.errors.title" label=" Name" placeholder="Slider Title"/>
                    <Image v-model="createForm.image"  :error="props.errors.image" label=" Image"/>
                    <span class="text-danger w-50 mt-4">Please upload images in JPG, PNG format with dimensions of 1000 x 800 pixels. The maximum file size allowed is 500 KB.</span>
        ...
        <Modal id="updateCategory" title="Create New Category" v-vb-is:modal>
            <form @submit.prevent="updateNewCategory(editData.id)">
                <div class="modal-body">
                    <Text v-model="updateForm.title" label="Category Name" placeholder="Category Name"/>
